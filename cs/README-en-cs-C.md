...
Při prezentování konečného nastavení lokalizačního workflow byste měli prokázat:
\- své celé nastavení v Memsource
\- že modifikace tohoto souboru spustí automatizovanou workflow
\- jak vaše automatizované nastavení skutečně funguje, a to tím, že nás provedete přes proces lokalizace provedené změny z předchozího kroku
\- jak se dokončení lokalizace propaguje do GitHub úložiště
